...
export default function Aboutus() {
  return (
    <div>
        ...
        <div className=" bg-white container mx-auto flex px-5 py-24">
          ...
          <div className=" bg-white lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div className=" bg-white flex justify-center">
              <button className=" bg-white inline-flex text-white bg-orange-400 border-0 py-2 px-3 focus:outline-none rounded text-lg">
                Show More
              </button>
      ...
      {/* Second Section */}
      <section className=" bg-white text-white body-font">
        <div className=" bg-white container mx-auto flex px-5 py-24 items-center justify-center flex-col w-[579px]">
            <h1 className=" bg-white text-black text-3xl text-bold mt-3">Why Choose Us</h1>
            <p className=" bg-white text-black text-center mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam 
            pellentesque bibendum non dui volutpat fringilla bibendum.</p>
          <Image
            className=" bg-white mb-10 object-cover object-center w-1320px h-386px mt-1552px ml-300px mt-10"
            alt="hero"
            src = "/about.png"
      ...
      <div className=" bg-white p-4 md:w-1/3">
        <div className=" bg-white h-full  flex justify-center items-center  flex-col border-2 rounded-lg overflow-hidden">
          ...
          <div className=" bg-white p-6">
            <h1 className=" bg-white title-font text-lg font-medium text-black mb-2 text-bold text-center">
            BEST CHEF
            </h1>
