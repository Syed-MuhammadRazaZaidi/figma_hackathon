...
function Hero() {
  return (
    <section className='w-full bg-[url("/heropic.png")] bg-transparent bg-cover bg-no-repeat bg-center py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28'>
      <div className='bg-transparent container mx-auto px-4'>
        <div className='bg-transparent flex flex-col items-center'>
          ...
          <div className='bg-transparent text-base sm:text-lg md:text-xl flex gap-2 text-center justify-center'>
            ...
            <Link href="/menu" className='bg-transparent text-[#FF9F0D]'>
              Menu
            </Link>
          </div>
        </div>
