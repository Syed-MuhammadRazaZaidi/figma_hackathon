    ...
    <div>
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row  gap-4">
          ...
          <section className="text-black bg-white">
            ...
            <div className="flex items-center justify-center mt-8 space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-black hover:bg-[#FF9F0D] rounded px-4 text-lg">
                  1
                </span>
                <span className="text-white bg-[#FF9F0D] text-lg px-4 py-1 rounded">
                  2
                </span>
                <span className="text-black px-4 hover:bg-[#FF9F0D] rounded text-lg">
                  3
                </span>
              </div>
        ...
        <div className="w-full md:w-[30%] lg:w-[25%] bg-white p-6">
          ...
          <div className="mb-6">
            <h3 className="font-bold text-[20px] leading-[28px] mb-2">
              Filter By Price
            </h3>
            <div className="border-t-2 border-[#FF9F0D] mb-2"></div>
            <p className="text-sm">From $0 to $8000</p>
            <button className="bg-[#FF9F0D] text-white px-4 py-2 mt-2 rounded-md">
              Filter
            </button>
          </div>

          <h3 className="font-bold text-[20px] leading-[28px] mb-4">
            Latest Products
          </h3>
